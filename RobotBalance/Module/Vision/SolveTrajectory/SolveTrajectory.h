...
extern float aim_x, aim_y , aim_z; // aim point 落点，传回上位机用于可视化
extern float pitch; //输出控制量 pitch绝对角度 弧度
extern float yaw;   //输出控制量 yaw绝对角度 弧度
//单方向空气阻力模型
...
void SolveTrajectory_Debug(void);
