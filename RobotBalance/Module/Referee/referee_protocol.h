...
typedef struct
{
	uint16_t chassis_voltage; //在新裁判系统中，被移除
	uint16_t chassis_current; //在新裁判系统中，被移除
	float chassis_power;      //在新裁判系统中，被移除
