...
void MX_UART5_Init(void)
{
  ...
  /* USER CODE BEGIN UART5_Init 2 */
	...
	// HAL_UART_Receive_DMA(&huart5,uart5_buffer,18);
  HAL_UARTEx_ReceiveToIdle_DMA(&huart5, uart5_buffer, 20);
...
void MX_UART7_Init(void)
{
  ...
  __HAL_UART_ENABLE_IT(&huart7, UART_IT_IDLE); 
	HAL_UART_Receive_DMA(&huart7,uart7_buffer,sizeof(uart7_buffer));
  // HAL_UARTEx_ReceiveToIdle_DMA(&huart7, uart7_buffer, sizeof(uart7_buffer));
...
void MX_USART1_UART_Init(void)
{
  ...
  __HAL_UART_ENABLE_IT(&huart1, UART_IT_IDLE); 
	HAL_UART_Receive_DMA(&huart1,uart1_buffer,255);
...
void MX_USART2_UART_Init(void)
{
  ...
  // __HAL_UART_ENABLE_IT(&huart2, UART_IT_IDLE); 
	// HAL_UART_Receive_DMA(&huart2,uart2_buffer,18);

  HAL_UARTEx_ReceiveToIdle_DMA(&huart2, uart2_buffer, sizeof(uart2_buffer));
...
void MX_USART10_UART_Init(void)
{
  ...
  // __HAL_UART_ENABLE_IT(&huart10, UART_IT_IDLE); 
	// HAL_UART_Receive_DMA(&huart10,uart10_buffer,255);
